...
For v1.1.2 the only registered provider is `minimax` (the [MiniMax](https://MiniMax.io) Token Plan). Adding another provider is a one-file drop-in; see [Architecture](architecture.md).
