...
v1.0.0 ships with **MiniMax** as the only registered provider. Adding more providers is a one-file drop-in — see [`okf/concepts/architecture.md`](okf/concepts/architecture.md).
